...
const VideoBlogCard: React.FC<VideoBlogCardProps> = ({ title, youtubeUrl }) => {
  ...
  return (
    <div className="border mb-4 rounded border-white">
      ...
      >
        <div className="p-2 border border-white rounded overflow-hidden h-[350px] md:h-[200px] lg:h-[260px] xl:h-[320px] relative">
          {videoId ? (
            <>
              <iframe
              ...
              ></iframe>
              <div className="absolute inset-0 bg-white flex items-center justify-center opacity-0 transition">
