...
const Contact = async () => {
  ...
  return (
    <>
      ...
      <div className="py-12 px-4 bg-gradient-to-br from-gray-50 via-white to-amber-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            <div className="inline-block relative">
              <h2 className="text-3xl lg:text-5xl font-bold text-gray-800 mb-4">
                Contact <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-600 to-amber-400">Us</span>
              </h2>
          ...
          {/* Main Content */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6 lg:gap-10 items-stretch">
            ...
            <div className="bg-gray-100 rounded-3xl shadow-xl p-8 lg:p-10 text-gray-800 h-full flex flex-col justify-between">

              {/* Header */}
              <div className="mb-8">
                <h3 className="text-2xl lg:text-3xl font-bold mb-2">Get in Touch</h3>
                <p className="text-gray-600 text-lg">Ready to find your perfect fragrance? We're here to help!</p>
              </div>
                ...
                {[
                  ...
                  <div key={i} className="flex items-start space-x-4 group">
                    ...
                    <div className="flex-1">
                      ...
                      {item.href ? (
                        <a href={item.href} className="text-gray-700 hover:text-gray-900 block">{item.desc}</a>
                      ) : (
              ...
              <div className="mt-8 pt-6 border-t border-gray-300">
                ...
                <div className="space-y-1 text-gray-700">
                  <div className="flex justify-between"><span>Monday - Saturday</span><span>9:00 AM - 9:00 PM</span></div>
